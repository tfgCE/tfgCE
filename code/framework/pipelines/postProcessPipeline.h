...
namespace Framework
{
	...
	public:
		...
		static ::System::ShaderSource const & get_use_with_post_process_fragment_shader_source() { an_assert(s_pipeline); return s_pipeline->useWithPostProcessFragmentShader; }
	...
	private:
		static PostProcessPipeline* s_pipeline;
		...
		::System::ShaderSource useWithPostProcessFragmentShader;
