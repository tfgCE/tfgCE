...
bool GoSubLabel::load_from_xml(IO::XML::Node const* _node, Framework::LibraryLoadingContext & _lc)
{
	bool result = true;
...
bool GoSubLabel::prepare_for_game(Framework::Library* _library, Framework::LibraryPrepareContext& _pfgContext)
{
	bool result = true;
...
ScriptExecutionResult::Type GoSubLabel::execute(ScriptExecution& _execution, ScriptExecution::Flags _flags) const
{
	if (ifCondition.is_set())
	{
