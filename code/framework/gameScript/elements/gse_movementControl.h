	...
	namespace GameScript
	{
		namespace Elements
		{
			...
			public: // ScriptElement
				...
				implement_ tchar const* get_debug_info() const { return TXT("movement control"); }

			private:
				Name objectVar;
				
				Optional<Name> switchTo;

				Optional<Vector3> requestedRelativeVelocity;
				Optional<Rotator3> requestedRelativeRotation;
				Optional<Vector3> requestedVelocityWS;
			};
		};
	};
};
