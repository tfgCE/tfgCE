...
namespace Framework
{
	 ...
	 */
	class GetParameterFromLibraryStored
	...
	private:
		MeshGenParam<LibraryName> libraryName;
		MeshGenParam<Name> paramName;
		MeshGenParam<Name> libraryType;

		bool mayFail = false;

		WheresMyPoint::ToolSet onFail;
		WheresMyPoint::ToolSet onSuccess; // implicits mayFail to true
	};
};
