...
namespace Framework
{
	namespace AppearanceControllersLib
	{
		...
		protected:
			virtual tchar const * get_name_for_log() const { return TXT("head"); }

		private:
			HeadData const * headData;
			bool isValid;
			Meshes::BoneID neckBone; // head parent
			Meshes::BoneID headBone;
			Meshes::BoneID eyesBone;
		...
		private:
			...
			MeshGenParam<Name> eyesBone;
			Transform headVRViewOffset = Transform::identity; // head in view space
