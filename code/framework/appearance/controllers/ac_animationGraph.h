...
namespace Framework
{
	namespace AppearanceControllersLib
	{
		...
		public:
			AnimationGraph(AnimationGraphData const * _data);
		...
		protected:
			virtual tchar const * get_name_for_log() const { return TXT("animation graph"); }

		private:
			UsedLibraryStored<Framework::AnimationGraph> animationGraph;

			Framework::AnimationGraphRuntime animationGraphRuntime;
		};

		class AnimationGraphData
		: public AppearanceControllerData
		{
			FAST_CAST_DECLARE(AnimationGraphData);
