	...
	namespace GameScript
	{
		namespace Elements
		{
			...
			public: // ScriptElement
				...
				implement_ tchar const* get_debug_info() const { return TXT("air prohibited place"); }

			private:
				Optional<bool> clearAll;
				Optional<Name> clear;
				Optional<Name> add;
				...
				Optional<bool> relativeToPlayersTileLoc;
			};
		};
	};
};
