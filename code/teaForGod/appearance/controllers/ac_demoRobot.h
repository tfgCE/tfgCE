...
namespace TeaForGodEmperor
{
	namespace AppearanceControllersLib
	{
		...
		protected:
			virtual tchar const * get_name_for_log() const { return TXT("demoRobot"); }
		...
		{
			FAST_CAST_DECLARE(DemoRobotData);
